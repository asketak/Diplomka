...
Deanonymization techniques chapter describes heuristics and methods that are used by the application to identify 
...
The application consists of multiple python scripts that falls into 5 categories.
======================================
...
Scripts for scraping Valhalla market in order to get statistical data about it's operation are in statistics folder.
...
and associated identity( e.q. nickname).
The script txToDat.py uses bitcoin-core api to 
...
\begin{itemize} 
 \item addresses.csv: Bitcoin addresses
 \item transactions.csv: transactions (hash)
 \item inputoutput.csv: list of transaction outputs (output\ key, id, value)
