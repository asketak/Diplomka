...
, drug markets, social media and blockchain.
    The tool can also for given bitcoin address find the nearest addresses or transactions related to drug markets
...
Deanonymization techniques chapter describes heuristics and methods that are later used by the application to detect 
...
XXX - popsat jeste hledani, shortest path mezi adresami
