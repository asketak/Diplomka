...
Most vendors tend to have small number of active listings,
...
\begin{figure}[!htb]
    ...
    \centering
    \caption{How many active listings sellers have}
...
The figure \ref{listingxprice} shows distribution of prices of all listings in
 the market on the left graph, on the right is the distribution of prices
 of listings mentioned in feedbacks. Some listings might be count multiple times
 in the right graph, because one listing might be bought and several times
 ...
 price in bitcoin * the average price of bitcoin for 30 days before the scraping
 (8219 EUR 20.1 - 20.2, daily snapshot from blockchain.info).
 ...
 buyers tends to buy amount of goods worth between 10 and 1000 EUR.
 The titles of high prices listings don't indicate that 
 these listings are somehow special except it's price.
 The average price of the bought goods (82.7 EUR) is way
 below someone who resell drugs would buy.
...
The mean is 93.7\% and median 98.3\% of positive feedbacks ratio.

 If we look at statistics of reviews from popular e-shop amazon(http://jmcauley.ucsd.edu/data/amazon/k)
