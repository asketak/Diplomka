...
the time it was not internationally popular.
...
active listings in. Most vendors sell goods just in one or two categories, hovewer there is substantional amount
of vendors with high revenue selling in multiple categories.
...
\begin{figure}[!htb]
    ...
    \caption{Amount of vendors clustered by categories they sell and their total revenue}
    \label{posratrev}
\end{figure}
...
on market. Majority(598 vendors \~ 60\%) of vendors have not had any positive or negative feedbacks, all of these vendors
...
They contain just titles like "custom listing for user: xxx", "custom listing 113" and so on.
...
and the rounded total number and price of trades performed by buyer.
From our 6000 feedbacks, we gathered 2595 unique combinations of four letters from username,
rounded number of trades and buyer's total spending.
There are possible $36^4=1679616$ combinations of 4 alfanumerical characters.
If we take rest of feedbacks 6000-2595 = 3405, than probability that

It is possible that two different buyers have the username prefix, suffix, amount of 
trades and revenue. 

%narozeninovy paradox = $36^4*7 combination(1679616,2654)*2654!/(1679616^2654)$
