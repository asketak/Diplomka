...
They download Valhalla market webpages with listings, vendors' profiles and feedbacks.
...
\end{itemize}
These files are later imported to database.
...
we were able to identify a significant percentage of cryptomarket's cashflow over given month.
