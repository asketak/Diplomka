...
performed multiple withdraws by smaller amount than the deposited on to receive bitcoins back.
...
if someone sent or received bitcoins from Valhalla cryptomarket.
...
deposit addresses, because the deposit addresses just received bitcoins from us and not sent them
...
identities received between 15.1 and 15.2. We scraped Valhalla cryptomarket between 14.2 and 15.2
...
64.2 BTC the market received during that one month timeframe.
