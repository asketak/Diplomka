...
n},
 ...
 as Tor services, PGP encryption is often required to communicate between multiple parties and bitcoin is used as a way of paying for goods or services.
    ...
    We stored all the data in a neo4j database, a graph database based on PostgreSQL.
    We created a tool collecting these data, importing them to the database, computing multiple heuristics
    ...
    The tool can find the nearest addresses or transactions related to drug markets for given bitcoin address
    ...
    multiple transactions to deposit and withdraw bitcoins. Into the tool, we imported the bitcoin addresses of
    the first profile we recieved bitcoins from, and certified the tool's ability to identify, whether the
    addresses owned by the second profile had also been sending/recieving bitcoins from the Valhalla market.
    },
...
Publicly available statistics prove that cybercriminals are much
 ...
 In the same year, FBI recieved 303809 complaints related to cyber crime, resulting in just 6 convictions. \cite{fbcyber} 
Criminals value their anonymity very highly and use various means to prevent being caught by police forces.
\cite{tzanetakis2016transparency}
\cite{van2013surfing}
\cite{aldridge2014not}
...
\cite{aldridge2014not}\cite{soska2015measuring}, because the positive feedback
...
Tor \cite{dingledine2004tor} is a free open source software that provides access to Tor network. Tor network is a network of Tor nodes.
...
The authors of the first research article \cite{reid2013analysis}
...
The first one is the same as \cite{reid2013analysis} did - all inputs of transaction
...
Advanced and similar work was done by \cite{spagnuolo2014bitiodine}. They downloaded the blockchain, transformed it to
...
Similar work to this thesis was done by \cite{fleder2015bitcoin}.
...
Article by Doliver \cite{dolliver2016characteristics} is most similar to this work.
